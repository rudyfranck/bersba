...
import com.rsba.monitor_ms.domain.input.AddEntityToCustomerInput
import com.rsba.monitor_ms.domain.input.CreateOrEditCustomerInput
import com.rsba.monitor_ms.domain.input.RemoveEntityOfCustomerInput
...
class CustomerDatabaseQuery {
    ...
    fun onRetrieveAllCustomer(token: UUID) =
        "SELECT on_retrieve_customers('$token')"
